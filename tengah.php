...
echo'<div class="banner">
  ...
  $deskripsi=substr($r[deskripsi],0,50);
  	echo"
                  <div class='imgeslider'><img src='foto_produk/$r[gambar]' alt='' title='product' width='220' height='240' />
...
$pesan="Terimakasih telah melakukan pemesanan online di Belanjayuk <br /><br />  
...
echo "<hr /><p>
			<div style='color:#E1473D;border:1px solid #E78686;padding:10px;background:#FFE1E1;'>
			  ...
			  Anda dapat melakukan Konfirmasi Pembayaran Melalui SMS Ke NO : <b>08991337413</b> 
			  <br/>Dengan Format : 
			  <b>#No Orders #Nominal Transfer # Bank Tujuan # Bank Pengirim</b> Contoh : 
			  <b> # $id_orders #$grandtotal_rp #BNI #BRI </b></div> <br /> <br />
